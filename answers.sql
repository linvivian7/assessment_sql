...
SELECT models.name AS model_name, brands.name AS brand_name, brands.headquarters FROM brands JOIN models USING (brand_id) WHERE models.name  = 'Mustang'; 
...
SELECT COUNT(*) FROM models WHERE brand_id=(SELECT brand_id FROM brands WHERE name='Ford'); 
...
SELECT * FROM models ORDER BY name ASC OFFSET 14 LIMIT 10; 
